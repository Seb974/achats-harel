  ...
  return (
      <div className="space-y-4" style={{ zIndex: 3000 }}>
        ...
        <label class="inline-flex items-center me-5 cursor-pointer">
          <input type="checkbox" value="" class="sr-only peer" checked={ consumer.report } onChange={ toggleReport }/>
          ...
          <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Vol reporté</span>
        </label>
        </div>
      </div>
  );
